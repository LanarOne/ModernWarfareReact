              ...
              <div className={`${mc.blocHistory}`}>
                ...
                <div className={`${mc.historyArt}`}>
                  ...
                  <p>
                    ...
                    technological beauty, two men inside the bot would operate
                    it for strategic purposes.
                  </p>
                  <p>
                    Since then, most of the ancient war mecas have been bought
                    by the construction business, inventing new uses that were
                    later inplemented in the new versions.
                  </p>
                </div>
              </div>
            )}
            {/*Media query for tablet and small screen responsive*/}
            {isMediumScreen && (
              <div className={`${mc.blocHistory}`}>
                <div className={`${mc.blocImg}`}>
                  <img
            ...
            {isSmallScreen && (
              <div className={`${mc.blocHistory}`}>
                ...
                <div className={`${mc.historyArt}`}>
                  ...
                  <p>
                    The journey of armored technologies brought us up into
                    space, it was only logical that we would engineer the first
                    floating station ever inhabited. It was for a long time the
                    legal and official base for our corporation.
                  </p>
                  <p>
                    This precise unit is still in Terra's orbit, although
                    originally built for ten thousand people to live in, it has
                    been upgraded since and can now shelter almost half a
                    million souls.
                  </p>
                  <p>
